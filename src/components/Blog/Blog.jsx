            ...
            <Container>
                <Flex className='justify-between'>
                    <div className='relative bg-[url(./assets/blogOne.png)] bg-center bg-cover bg-no-repeat pt-[55px] pb-[75px] w-[339px]'>
                        ...
                        <button className='relative z-3 py-[11px] px-[23px] bg-white/60 ml-[46px] mt-[52px] text-white cursor-pointer font-primary font-semibold text-[12px] hover:bg-transparent border border-white/60 transition duration-500'>Read more</button>
                    </div>
